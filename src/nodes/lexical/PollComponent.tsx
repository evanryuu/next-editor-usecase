...
import joinClasses from '@/utils/lexical/joinClasses'
...
export default function PollComponent({ question, options, nodeKey }: { nodeKey: NodeKey; options: Options; question: string }): JSX.Element {
