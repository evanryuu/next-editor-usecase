...
import { startImageUpload } from '../plugins/UploadImage'
...
const CommandList = ({
  ...
  return items.length > 0 ? (
    <div
      ...
      className="z-1 h-auto max-h-[330px] w-72 overflow-y-auto rounded-md border border-stone-200 bg-white px-1 py-2 shadow-md transition-all"
    >
