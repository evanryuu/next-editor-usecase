...
const EditorBubbleMenu: FC<TiptapBubbleMenuProps> = (props) => {
  ...
  return (
    <BubbleMenu
      {...bubbleMenuProps}
      className="flex w-fit animate-fade-in divide-x divide-stone-200 rounded border border-stone-200 bg-1 opacity-100 shadow-xl"
    ...
    >
      ...
      <div className="flex">
        ...
        <LinkSelector
          editor={props.editor}
          isOpen={openedMenu === 'link'}
          setIsOpen={(bool: boolean) => setIsOpen(bool, 'link')}
        />
      </div>
      <TextColorSelector
        editor={props.editor}
