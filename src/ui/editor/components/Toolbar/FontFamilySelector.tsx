...
export const FontFamilySelector: FC<FontFamilySelector> = ({ editor, isOpen, setIsOpen }) => {
  const activeFontFamily = FONT_FAMILIES.find(({ fontFamily }) =>
    ...
    <Popover.Root open={isOpen}>
      <div className="relative h-full w-[120px] truncate">
        ...
        >
          ...
          <span
            className="line-clamp-1 w-[60px] rounded-sm px-1"
            style={{
        ...
        >
          <div className="my-1 px-2 text-xs font-semibold text-stone-500">FONT FAMILY</div>
