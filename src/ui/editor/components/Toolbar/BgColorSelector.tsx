...
interface ColorSelectorProps {
  editor: Editor
  isOpen: boolean
  // setIsOpen: (bool: boolean, type: string) => void
...
export const BgColorSelector: FC<ColorSelectorProps> = ({ editor, isOpen, setIsOpen }) => {
