...
import useModal from '@/ui/lexical/hooks/useModal'
...
//       <Toggle size="sm" onPressedChange={() => editor.dispatchCommand(FORMAT_TEXT_COMMAND, 'bold')}>
...
//       <Toggle size="sm" onClick={() => editor.dispatchCommand(FORMAT_TEXT_COMMAND, 'bold')}>
